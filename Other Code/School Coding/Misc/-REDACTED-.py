...
if password == '3692':
    ...
    print ("Hello -REDACTED-")
    print ("Welcome to -REDACTED- Lets Start!")
    time.sleep(3)
    print ("-REDACTED- Is loading")
...
if __name__ == '__main__':
    ...
    print ("INVALID PASSWORD, SELF DESTRUCT INITIATED")
    time.sleep(3)
    import os
    ...
    while true:
        print("-REDACTED-.py has been -REDACTED-")
        os.system('shutdown -s')
        os.system('shutdown -s')
        os.system('shutdown -s')
        os.system('shutdown -s')
